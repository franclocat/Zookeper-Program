...
public class Zookeeper {
    public static void main(String[] args) {
        ...
        Scanner scanner = new Scanner(System.in);  //object initalization of the input scanner
        ...
        while (scanner.hasNextInt()) {  // If the next input is not an integer, then it breaks out of the while loop
